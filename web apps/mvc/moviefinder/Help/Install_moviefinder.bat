...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "moviefinder" /productName "moviefinder" > NUL
...
COPY /Y "moviefinder.msha" HelpContentSetup.msha
