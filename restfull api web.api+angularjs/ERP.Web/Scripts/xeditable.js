  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
    ...
    self.render = function() {
      ...
      self.inputEl.addClass('editable-input');
        self.inputEl.css('width', '100% !important;');
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs2': {
      ...
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl: '<button type="submit" class="btn btn-primary btn-xs xedit-ok"><span class="icon-ok icon-white"></span></button>',
      cancelTpl: '<button type="button" class="btn xedit-cancel" ng-click="$form.$cancel()">' +
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl: '<button type="submit" class="btn btn-primary btn-xs xedit-ok"><span class="glyphicon glyphicon-ok"></span></button>',
      cancelTpl: '<button type="button" class="btn btn-default xedit-cancel" ng-click="$form.$cancel()">' +
